...
@click.option('--disable_dunder_methods', is_flag=False, help="Disable dunder method filter")
@click.option('--disable_no_docstring', is_flag=False, help="Disable functions w/o docstring filter")
@click.option('--disable_signature_filters', is_flag=False, help="Disable function signature filters (args, returns)")
@click.option('--disable_keyword_filters', is_flag=False, help="Disable keyword filters (docstring, body, name)")
@click.option('--disable_wrapper_filters', is_flag=False, help="Disable filters for wrappers (decorators, etc.)")
@click.option('--disable_lines_filter', is_flag=False, help="Disable lines filter")
@click.option('--disable_all_filters', is_flag=False, help="Disable all filters")
def extract(**kwargs):
